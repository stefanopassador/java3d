...
public class MayaPyramid extends Group {
    ...
    public MayaPyramid() {
        ...
        for (int i = 0; i < BOXES_COUNT; i++) {
            ...
            // Divido MAX_SIZE  per BOXES_COUNT + 5
            // perché mi permette di avere l'ultimo box più grande
        ...
        float x = BOXES_HEIGHT * BOXES_COUNT * 2 - BOXES_HEIGHT + top_size;
        transformation.setTranslation(new Vector3d(
                0.0f, 0.0f, x)
        );
        TransformGroup upTG = new TransformGroup(transformation);
    ...
    private static Appearance createAppeareance() {
        ...
        // Definisco il colore
        mAppearance.setColoringAttributes(new ColoringAttributes(
                255, 0, 0, ColoringAttributes.SHADE_GOURAUD)
        );
        ...
        mAppearance.setPolygonAttributes(new PolygonAttributes(
